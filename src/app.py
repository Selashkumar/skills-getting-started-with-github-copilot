...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop skills and compete in school basketball games",
    ...
    "Art Studio": {
        ...
        "max_participants": 15,
        "participants": ["lisa@mergington.edu", "ivy@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Debate Team": {
        "description": "Prepare for debates and practice public speaking skills",
